...
mod transaction_tests {
    ...
    #[sqlx::test]
    async fn test_migrate_tier_same_tier_rollback(
        pool: PgPool,
    ...
    #[sqlx::test]
    async fn test_migrate_tier_invalid_transition_rollback(
        pool: PgPool,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let repo = MemoryRepository::new(pool.clone());
    ...
    #[sqlx::test]
    async fn test_successful_migration_commits(
        pool: PgPool,
    ) -> Result<(), Box<dyn std::error::Error>> {
        let repo = MemoryRepository::new(pool.clone());
...
mod insights_transaction_tests {
    ...
    #[sqlx::test]
    async fn test_insights_get_by_id_no_transaction(
        pool: PgPool,
    ) -> Result<(), Box<dyn std::error::Error>> {
