...
impl TestingEffectEngine {
    ...
    pub async fn process_retrieval_attempt(
        ...
        let new_strength = self.apply_consolidation_boost(
        ...
        let ease_factor_change = self.calculate_ease_factor_change(
            attempt.success,
            difficulty_score,
        );
    ...
    fn validate_research_compliance(
        ...
        ResearchCompliance {
            ...
            consolidation_boost_within_research_bounds: consolidation_boost >= 0.5 && consolidation_boost <= 2.0,
    ...
    pub async fn get_statistics(&self) -> Result<TestingEffectStatistics> {
        ...
        Ok(TestingEffectStatistics {
            ...
            average_consolidation_strength: raw_stats["average_consolidation_strength"].as_f64().unwrap_or(0.0),
            ...
            average_current_interval_days: raw_stats["average_current_interval_days"].as_f64().unwrap_or(1.0),
...
mod tests {
    ...
    fn test_consolidation_boost_calculation() {
        ...
        let boost = engine.calculate_consolidation_boost(
            true,
            0.5,
